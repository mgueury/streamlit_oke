...
ORACLE_DB_USER = "XXXXXX"  #Enter your oracle vector Db username
ORACLE_DB_PWD = "XXXXXX"  #Enter your oracle vector Db password
ORACLE_DB_HOST_IP = "XXXXXX"  #Enter your oracle vector Db host ip
ORACLE_DB_PORT = 1521   #Enter your oracle vector Db host port
ORACLE_DB_SERVICE = "XXXXXXX" 
